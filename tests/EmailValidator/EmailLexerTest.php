...
class EmailLexerTest extends TestCase
{
    ...
    public function testLexerTokens($str, $token)
    {
        ...
        $lexer->moveNext();
        $lexer->moveNext();
        $this->assertEquals($token, $lexer->getToken()['type']);
    }
    ...
    public function testLexerParsesMultipleSpaces()
    {
        ...
        $lexer->moveNext();
        $lexer->moveNext();
        $this->assertEquals(EmailLexer::S_SP, $lexer->getToken()['type']);
        $lexer->moveNext();
        $this->assertEquals(EmailLexer::S_SP, $lexer->getToken()['type']);
    }
    ...
    public function testLexerParsesInvalidUTF8($char)
    {
        ...
        $this->assertEquals(EmailLexer::INVALID, $lexer->getToken()['type']);
    }
    ...
    public function testLexerForTab()
    {
        ...
        $lexer->moveNext();
        $this->assertEquals(EmailLexer::S_HTAB, $lexer->getToken()['type']);
    }
    ...
    public function testLexerForUTF8()
    {
        ...
        $lexer->moveNext();
        $lexer->moveNext();
        $this->assertEquals(EmailLexer::GENERIC, $lexer->getToken()['type']);
        $lexer->moveNext();
        $this->assertEquals(EmailLexer::GENERIC, $lexer->getToken()['type']);
    }
